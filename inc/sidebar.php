<aside>
    <div class="mt-5"><img class="img-fluid rounded rounded-2" src="/images/me.jpg" alt="Alex"></div>
    ...
    <div class="mt-5 mx-auto d-inline-block text-center border border-dark-subtle rounded-3 bg-body-tertiary py-3 px-3">
        ...
        <div class="mt-3">
            ...
            <a class="fw-bold text-decoration-none btn btn-outline-dark px-4 mx-2 my-2" href="/resume/Resume_AlexUlogov.pdf">
